...
function displayCart(){
  ...
  cartdata = '<table><tr><th>Name of Item</th><th>Quantity</th><th>Price</th><th>Total</th></tr>';
  ...
  for (i=0; i<inames.length; i++){
    ...
    cartdata += "<tr><td>" + inames[i] + "</td><td>" +
                 iqtyp[i] + "</td><td>" + iprice[i] + "</td><td>" + iqtyp[i] * iprice[i] +
    "</td><td><span onclick='delElement(" + i + ")' id='addBtn'>Delete</span></td></tr>"
  }
